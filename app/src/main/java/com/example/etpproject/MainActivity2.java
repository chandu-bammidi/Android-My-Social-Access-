...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            Toast.makeText(MainActivity2.this,"User Registered Successfully", Toast.LENGTH_LONG).show();

        }
        else {

            Toast.makeText(MainActivity2.this,"Please Fill All The Required Fields.", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            Toast.makeText(MainActivity2.this,"Email Already Exists",Toast.LENGTH_LONG).show();
